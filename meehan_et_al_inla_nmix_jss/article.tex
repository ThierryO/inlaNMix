...
The purpose of this study was to demonstrate the use of the \pkg{R-INLA} package \citep{Rue_Martino_Lindgren_Simpson_Riebler_2013} to analyze N-mixture models and to compare performance of \pkg{R-INLA} to two other common approaches, \proglang{JAGS} \citep{plummer2003jags,Lunn_Jackson_Best_Thomas_Spiegelhalter_2012}, via the \pkg{runjags} package \citep{Denwood_2016}, which employs MCMC methods and allows Bayesian inference, and the \pkg{unmarked} package \citep{Fiske_Chandler_others_2011}, which uses Maximum Likelihood and allows frequentist inference.
